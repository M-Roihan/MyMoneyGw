                    ...
                    <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                        <div>
                            ...
                            <p className="text-slate-500 text-sm mt-1">
                                Kelola semua rekening, e-wallet, dan uang tunai
                                Anda.
                            </p>
                        </div>
                        <button
                    ...
                    {loading ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[1, 2, 3].map((i) => (
                                <div
                                    key={i}
                                    className="bg-white rounded-3xl p-6 border border-gray-100 animate-pulse h-40"
                                ></div>
                            ))}
                        </div>
                    ) : accounts.length === 0 ? (
                        <div className="bg-white rounded-3xl p-12 text-center border border-gray-100 shadow-sm">
                            ...
                            <p className="text-slate-500 mb-6 max-w-md mx-auto">
                                Anda belum menambahkan akun keuangan apapun.
                                Tambahkan cash, rekening bank, atau e-wallet
