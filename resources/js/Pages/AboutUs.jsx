...
export default function AboutUs() {
    const teamMembers = [
        { name: "Alfi Adriansyah", nim: "235008110 6", role: "Backend Developer", desc: "Bertanggung jawab pada arsitektur database dan API Laravel", color: "#2563eb" },
        { name: "Rifky Aditya Kamil", nim: "235008111 2", role: "Frontend Developer", desc: "Membangun antarmuka pengguna dengan React dan Tailwind CSS", color: "#10b981" },
        ...
        <AppLayout title="About Us">
            ...
            <section className="bg-gradient-to-br from-slate-900 to-blue-900 text-white py-24 px-6 text-center rounded-b-[3rem] shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-3xl mx-auto">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight mb-4">FinanceKu</h1>
            ...
            <div className="max-w-6xl mx-auto px-6 -mt-12 relative z-20 space-y-12">
                ...
                <section className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100 flex flex-col justify-center">
                        <div className="w-12 h-12 bg-blue-50 text-blue-600 rounded-xl flex items-center justify-center text-2xl mb-6">👁️</div>
                        <h2 className="text-2xl font-bold text-slate-900 mb-4">Visi Kami</h2>
                        <p className="text-slate-600 leading-relaxed font-medium">
                            "Menjadi platform keuangan digital terpercaya yang membantu masyarakat Indonesia mengelola keuangan dengan lebih bijak"
                        </p>
                    </div>
                    <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
                        <div className="w-12 h-12 bg-emerald-50 text-emerald-600 rounded-xl flex items-center justify-center text-2xl mb-6">🎯</div>
                ...
                <section>
                    <div className="text-center mb-10">
                        ...
                        <p className="text-slate-500 mt-2">Orang-orang hebat di balik berdirinya FinanceKu</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {teamMembers.map((member, idx) => {
                            const initials = member.name.split(' ').map(n => n[0]).join('').substring(0, 2).toUpperCase();
                            return (
                                <div key={idx} className="bg-white rounded-3xl p-6 flex flex-col sm:flex-row gap-5 items-start sm:items-center border border-slate-100 shadow-sm hover:shadow-xl hover:-translate-y-1 transition-all duration-300 group">
                                    <div 
                                    ...
                                    <div className="flex-1">
                                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-1">
                                            <h3 className="text-lg font-bold text-slate-900 leading-none">{member.name}</h3>
                                            <span 
                                        ...
                                        <p className="text-xs text-slate-400 font-bold mb-3 font-mono tracking-wider">NIM: {member.nim}</p>
                ...
                <section className="bg-white rounded-3xl p-8 md:p-10 border border-slate-100 shadow-sm text-center">
                    <h2 className="text-2xl font-bold text-slate-900 mb-8">Teknologi yang Digunakan</h2>
                    <div className="flex flex-wrap justify-center gap-4">
                        {techStack.map((tech, idx) => (
                            <div key={idx} className={`flex items-center gap-2 px-5 py-3 rounded-2xl ${tech.color} font-bold shadow-sm hover:scale-105 transition-transform cursor-default`}>
                ...
                <footer className="text-center pt-8 border-t border-slate-200 mt-12 pb-4">
                    <p className="text-slate-500 text-sm font-medium">
                        © 2026 FinanceKu — Program Studi Informatika, Universitas Jenderal Achmad Yani
                    </p>
                </footer>
            </div>
            </div>
