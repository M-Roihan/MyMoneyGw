                    ...
                    <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                        <div>
                            ...
                            <p className="text-slate-500 text-sm mt-1">
                                Wujudkan impian Anda dengan target tabungan yang
                                jelas.
                            </p>
                        </div>
                        <button
                    ...
                    {loading ? (
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[1, 2, 3].map((i) => (
                                <div
                                    key={i}
                                    className="bg-white rounded-3xl p-6 border border-slate-200 shadow-sm animate-pulse h-48"
                                ></div>
                            ))}
                        </div>
                    ) : savings.length === 0 ? (
                        <div className="bg-white rounded-3xl p-12 text-center border border-slate-200 shadow-sm">
                            ...
                            <p className="text-slate-500 mb-6 max-w-md mx-auto">
                                Anda belum memiliki target tabungan. Mulailah
                                merencanakan masa depan keuangan Anda sekarang.
                            </p>
                            <button
                                onClick={handleOpenAdd}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {savings.map((sav) => {
                                ...
                                return (
                                    <div
                                        key={sav.id}
                                        className="bg-white rounded-3xl p-6 shadow-sm border border-slate-200 hover:shadow-md transition-all relative group"
                                    >
                                        <div className="absolute top-6 right-6 text-2xl opacity-80">
                                            🎯
                                        </div>

                                        <h3 className="text-lg font-bold text-slate-900 mb-4 pr-8">
                                            {sav.name}
                                        </h3>
                            ...
                            >
                                <div>
                                    ...
                                    <p className="text-xs text-slate-400 mt-2">
                                        Maksimal setoran tidak boleh melebihi
                                        target tabungan.
                                    </p>
                                </div>
